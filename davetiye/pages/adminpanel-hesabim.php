...
<body>
  <?php include 'adminpanel-header.php'; ?>
      ...
      <div class="row">
		...
		<div class="container ">
      <h2 style="margin-left:530px;">Hesabım</h2><br>
           ...
           <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                ...
                <button type="submit" class="btn btn-default  btnuye" name="uyeguncelle">  Güncelle </button>
                <?php echo '<a href="adminpanel-sifre-guncelle?uye_Id='.$gelenid.'"'; ?><button type="submit" class="btn btn-default  btnuye" name="uyesifre"> Şifreyi Değiştir</a></button>
              </div>
            </div>
          </form>
        </div>
...
if (isset($_POST['uyeguncelle']))
              { 
                ...
                $kilce = $_POST['ilce'];
                  ...
                  $query = mysql_query("UPDATE `tbluye` SET uyeAd='$kad',  uyeSoyad='$ksoyad', uyeTel='$ktel' , uyeUlke='$kulke' , uyeSehir='$ksehir' , uyeIlce='$kilce' WHERE `tbluye`.`uyeId` = '$gelenid1'");   

                  echo '<script>alert("Güncelleme İşlemi Başarıyla Gerçekleşmiştir. Lütfen Tekrar Giriş Yapınız.")</script>'; 
                  echo '<script>window.location="adminpanel-logout.php"</script>';
}
?>
