...
<?php $title="Ana Sayfa - Davetiyem.com"; 
    ...
    <body>
      ...
      <h2 style="text-align: center">Hesabım</h2><br>
           ...
           <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                ...
                <?php echo '<a href="sifre-guncelle?uye_Id='.$gelenid.'"'; ?><button type="submit" class="btn btn-default  btnuye" name="uyesifre"> Şifreyi Değiştir</a></button>
              </div>
            </div>
          </form>
        </div>
